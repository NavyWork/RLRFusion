...
plugin = True
plugin_dir = 'plugin/RLRFusion-main/'
...
work_dir = None
load_from = None
resume_from = '/home/A2-LiRaFusion/work_dirs/centerpoint_7/epoch_2.pth'
...
radar_use_dims = [0, 1, 2, 5, 8, 9, 14, 15, 18]
