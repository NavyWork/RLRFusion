...
from plugin.RLRFusion.models.backbones.bev_fusion_layer import build_bev_fusion_layer
...
class CenterPoint_7(MVXTwoStageDetector):
    ...
    def extract_lidar_only(self, lidar_pts_lst):
    ...
    def extract_feat_v3(self, lidar_pts, img, img_metas, fused_points=None, radar=None, mode='train'):
        ...
        voxels_feats = self.extract_lidar_only(lidar_pts_lst)
