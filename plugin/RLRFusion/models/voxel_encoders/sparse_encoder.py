...
class SparseEncoder_out(nn.Module):
    ...
    def forward(self, voxel_features, coors, batch_size):
        ...
        return lcoors, spatial_features
...
@MIDDLE_ENCODERS.register_module()
class SparseEncoderSASSD_out(SparseEncoder_out):
    ...
    def __init__(self,
                 ...
                 encoder_paddings=((1, ), (1, 1, 1), (1, 1, 1), ((0, 1, 1), 1,
                                                                 1)),
                 block_type='conv_module'):
        super(SparseEncoderSASSD_out, self).__init__(
